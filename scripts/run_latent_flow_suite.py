...
def _row(metrics: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "latent_RMSE": metrics.get("latent_RMSE"),
        "latent_step_mse": metrics.get("latent_step_mse"),
        "latent_cosine_similarity": metrics.get("latent_cosine_similarity"),
        "one_step_error": metrics.get("one_step_error"),
        "multi_step_rollout_error": metrics.get("multi_step_rollout_error"),
        "delta_ADE": metrics.get("delta_ADE"),
        "residual_ADE": metrics.get("residual_ADE"),
        "residual_mode": metrics.get("residual_mode"),
        "minADE_4": metrics.get("minADE_4"),
        "minFDE_4": metrics.get("minFDE_4"),
        ...
        "noise_scale": metrics.get("noise_scale"),
        "num_sampling_steps": metrics.get("num_sampling_steps"),
