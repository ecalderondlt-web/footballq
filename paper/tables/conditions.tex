...
\begin{table}[h]
  ...
  \begin{tabular}{llp{7.2cm}}
    ...
    \bottomrule
  \end{tabular}
  \caption{Falsification conditions. A representation that is insensitive to a
  semantically meaningful corruption, or that fails to beat the no-motion
  identity, is blocked regardless of its loss value.}
